...
/*   Updated: 2020/02/17 22:43:00 by aelphias         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_menu(t_fdf *data)
{
	...
	mlx_string_put(mlx, win, 15, y += 25, color, "Rotate:  W, S - OX");
	mlx_string_put(mlx, win, 15, y += 25, color, "Rotate:  A, D - OY");
	mlx_string_put(mlx, win, 15, y += 25, color, "Rotate:  4, 6 - OZ");
}
